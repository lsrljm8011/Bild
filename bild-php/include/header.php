...
<nav>
    ...
    <ul>
        <li><a href="../edit/edit-image.php">EDIT</a></li>
...
<div class="member">
    ...
    <?php if( isset($_SESSION['myMemberID']) ){ ?>
            <a href="#">
                <div class="img-wrap">
                    <a href="../pages/main.php"><img src="../assets/img/L.png" alt="아이콘이미지"></a>
                    <a href="#"><img src="../assets/img/bell.png" alt="아이콘이미지"></a>
                    <a href="../gallery/gallery.php"><img src="../assets/img/pf.png" alt="아이콘이미지"></a>
                </div>
            </a>
