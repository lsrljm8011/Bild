    ...
    <main id="contents">
        <section id="mainCont">
            ...
            <article class="content-article">
                <div class="boardType container">
                    <h3>Board Modify</h3>
                    <div class="board-container">
                        <div class="board-wrap mt70">
                            <form action="boardModifySave.php" name="boardWrite" method="post">
                                <fieldset>
                                    <legend class="ir_so">게시판 내용 수정하기 영역입니다.</legend>
                                ...
                                <div class="boardModifyBtn">
                                    ...
                                    <button class="btn_submit3" type="submit" value="취소하기"><a href="#" onClick="history.back()">취소하기</a></button>
