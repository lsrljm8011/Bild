                    ...
                    <div class="boardView-container">
                        ...
                        <div class="board-wrap">
                            <form action="boardWriteSave.php" name="boardWrite" method="post">
                                <fieldset>
                                    <legend class="ir_so">게시판 보가 영역입니다.</legend>
                        ...
                        <button class="btn btn_submit3" type="submit" value="삭제하기"><a href="#" class="deleteBtn">삭제하기</a></button>
                        <button class="btn btn_submit3" type="submit" value="수정하기"><a href="boardModify.php?boardID=<?=$_GET['boardID']?>">수정하기</a></button>
                    </div>
                </div>
            </article>
